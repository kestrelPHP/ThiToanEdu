...
<?php
	...
	$results = mysql_query("SELECT * FROM xh_user WHERE id='$id'");
	while($rows = mysql_fetch_array($results))
	{
			...
			$sodt=$rows['sodt'];
			$level=$rows['level'];
			$phancap=$rows['phancap'];
			$hinhanh=$rows['image'];

	}
?>
<div style="margin:20px 70px 10px; font-size:14px;">
<font size="2" face="Tahoma"><b><a href="?menu=hocsinh_list">Quản lý giáo viên</a><img src="images/bl3.gif" border="0" /> Sửa thông tin</b></font></div>
<hr size="1" color="#cadadd" style="margin:15px auto;" />
<form action="?menu=sua_user_save" method="post" class="hocsinh_edit" enctype="multipart/form-data">


<table width="100%" border="0"  cellpadding="0" cellspacing="0" background="images/body.png" id="dethi_news">
    <tr>
		<td bgcolor="#CCCCCC"  height="38px"colspan="2" align="center" class="style1">SỬA THÔNG TIN GIÁO VIÊN</td>
    </tr>
	...
	<tr>
		...
		<td width="80%"> <input size=30 type="text" name="id" readonly="readonly" class="tendethi" value="<?php echo $id; ?>"/></td>
	</tr>
	...
	<tr>
		...
		<td width="80%"> <input size=30 type="text" name="level"  class="tendethi" value="<?php echo $level; ?>"/></td>
	</tr>
 
    <tr>
      <td align="center" class="tbltitle">Phân cấp:</td>
	    <td width="85%"> <input class="tendethi" type="text" name="phancap" value="<?php echo $phancap ;?>" ></td>
    </tr>
	...
	<tr>
		...
		<td>
			...
			<input type="hidden" name="imgfile" value="<?php echo $hinhanh ; ?>" /><img src="../upload/images/user/<?php echo $hinhanh ; ?>" height="80px" width="90px" alt="Hình ảnh"/>
		</td>
	</tr>
