...
<?php
			include('config.php');
			$counts=0;
			$rscount = mysql_query("SELECT * FROM xh_tonghopkq_tl");
...
?>
<?php //Thêm Phân trang ----------------------------------------------------------
	$tbl_name="xh_tonghopkq_tl";		//Tên bảng cần phân trang
...
<font size="2" face="Tahoma"><b><a href="?menu=thong_ke_tl">Tổng hợp kết quả</a><img src="images/bl3.gif" border="0" /> Thống kê kết quả tự luyện của học sinh</b></font></div>
<hr size="1" color="#cadadd" style="margin:15px auto;" />
<div class='wrapper'>
<form action="?menu=xoa_thkq_tl" method="post">
    ...
    <table cellpadding="1" cellspacing="1" id="resultTable">
        ...
        <tbody>
		<?php
//			$results = mysql_query("SELECT * FROM xh_tonghopkq_tl ");  //Nếu không phân trang thì dùng
			...
			echo '<tr class="teacher">
				...
				<td><a href="?menu=thkq_chitiet_tl&idhs='.$rows['idhs'].'&made='.$rows['made'].'."><img src="images/go_right.gif" /></a></td>
			</tr>';
			}
		?>
        </tbody>
