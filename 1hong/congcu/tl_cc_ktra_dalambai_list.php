...
<?php
			include('config.php');
			$counts=0;
			$rscount = mysql_query("SELECT * FROM xh_ktbailam_tl");
...
?>
<?php //Thêm Phân trang ----------------------------------------------------------
	$tbl_name="xh_ktbailam_tl";		//Tên bảng cần phân trang
	$limit = 20; 				//Số dòng trên 1 trang
	$targetpage = "index.php?menu=ktra_hsdalambai_tl"; 	//đường dẫn chạy file này
...
<font size="2" face="Tahoma"><b>Học sinh<img src="images/bl3.gif" border="0" />Danh sách học sinh đã tự luyện</b></font></div>
...
<div class='wrapper'>
  ...
  <form action="?menu=xoa_ktra_hsdalambai_tl" method="post">
...
//			$results = mysql_query("SELECT * FROM xh_ktbailam "); //Nếu không phân trang thì dùng
