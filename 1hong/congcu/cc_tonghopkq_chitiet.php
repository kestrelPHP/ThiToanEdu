...
<?php
	...
	$results3 = mysql_query("SELECT * FROM xh_tonghopkq WHERE idhs='$idhs' and made='$made' ");
	$rows3 = mysql_fetch_array($results3);


?>
<center><a href='?menu=thong_ke' class="style2" >Về trang thống kê kết quả thi</a></center>
...
<!-- ---------------------------------------------------------------------------------- -->
			<tr>
				<th colspan="2" class="style"><center><b>THÔNG TIN VỀ ĐỀ THI</b></center></th>
			</tr>
...
<!-- ---------------------------------------------------------------------------------- -->
			<tr>
				<th colspan="2" class="style"><center><b>THÔNG TIN VỀ KẾT QUẢ LÀM BÀI</b></center></th>
			</tr>
