...
<form action="index.php?page=tl_cn_kq" id = "submitForm" method="POST" name="frmdethi" enctype="multipart/form-data">
	...
	?>
        ...
        <tbody>
				...
				<tr style="color:#00F; background:#FCF;">
					...
					<td> <textarea name="dapso[]" value="" style= "width: auto; height: 30px; scroll: auto;" ></textarea> </td>
				</tr>
        </tbody>
