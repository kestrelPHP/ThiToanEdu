...
//	$tbl_name="xh_dethi";					//Tên bảng cần phân trang
	...
	$targetpage = "index.php?page=tl_theomon"; 	
//<!--END PHÂN TRANG-->

if(isset($_SESSION['khoihoc'])) 
{
	$tbl_name="xh_dethi WHERE khoi='".$_SESSION['khoihoc']."' and mon='$monthi' and hinhthuc='2' ";		
}
else 
	{
	$tbl_name="xh_dethi WHERE mon='$monthi' and hinhthuc='2' ";		
	}
...
?>
		<div class="dethi">
			<a href="?page=tl_chapnhan&made=<?php echo $row['made'];?>"><?php echo $row['tende'];?></a></h3>
			<p class="dethi1"><?php echo $row['noidung'];?></p>
		</div>

		<div class="images" style="padding: 0px 0 0px 5px;">
			<a href="?page=tl_chapnhan&made=<?php echo $row['made'];?>">
