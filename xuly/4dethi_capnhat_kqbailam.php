...
//----------------------------------------------------
	$ghikq="insert into xh_kqbailam(idhs,made,macau,kqchon,chamdiem) values('".$layidhs."','".$laymade."','".$macau."','".$kqchon."','".$chamdiem."')";
...
echo"<script>document.location.href='?page=xem_kq' </script>";
?>
