...
<head profile="http://gmpg.org/xfn/11">
    ...
    <?php include("xuly/config/connect.php");
    include("rewrite.php");
    include("page_lay_link.php"); ?>
</head>
...
<div id="trangchu" class="container">
    <div class="row">
        ...
        <div id="wrap"> <!-- Begin Wrap -->
            <div id="main_page" class="col-xs-12 col-md-9 sept-right {
"> <!-- main_page -->
                <div class="row2">
            ...
            <div id="right_col" class="col-xs-12 col-md-3"> <!-- Right -->
                <div class="row2">
                    <ul>
